...
metadata {
    ...
    definition (name: "Simulated Switch with HTTP GET", namespace: "smartthings/testing", author: "bob", runLocally: false, mnmn: "SmartThings", vid: "generic-switch") {
        capability "Switch"
    ...
    preferences {
        input name: "controllerHost", type: "text", title: "Controller host", description: "IP of host to send requests to", required: true
        input name: "pathOn", type: "text", title: "On path", description: "Path to get when turning on", required: true
        input name: "pathOff", type: "text", title: "Off path", description: "Path to get when turning off", required: true
    }
}
